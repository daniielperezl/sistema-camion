...
<head>
    ...
    <style>
        ...
        .number-icon {
            ...
            text-align: center;
            border-radius: 50%;
            line-height: 24px; /* Match icon size */
            font-size: 12px;
...
<body>
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <ul class="sidebar-menu">
            <li><a href="#" onclick="showSection('ruta_hoy', this)">Ruta del Día</a></li>
    ...
    <main class="main-content">
        ...
        <!-- Today's Route Section (Default) -->
        <div id="ruta_hoy" class="section hidden">
            <h2 class="section-header">Ruta del Día - <span id="today-date-display"></span></h2>

            <div class="form-group">
                <input type="text" id="search-today" placeholder="Buscar comercio o dueño..." oninput="searchTodayRoute()">
            </div>

            <div id="map-today" style="height: 400px; width: 100%; border: 1px solid #ccc;"></div>
        ...
        <div id="rutas" class="section hidden">
            ...
            <div class="form-group">
                 <input type="text" id="search-admin" placeholder="Buscar comercio o dueño..." oninput="searchAdminRoute()">
            </div>
            ...
            <div id="route-content" class="hidden">
                ...
                <div id="add-stop-form" class="hidden" style="background: #fff; padding: 15px; border: 1px solid #ddd; margin-bottom: 20px;">
                    <h4 id="form-title">Nuevo Comercio</h4>
                    <p><em>Haga clic en el mapa para establecer la ubicación exacta.</em></p>
                    <form id="newStopForm">
                        <input type="hidden" name="id" id="stop_id">

                        <div class="form-group">
                            <label>Orden en la Ruta</label>
                            <input type="number" name="order_index" id="order_index" placeholder="Automático si se deja vacío">
                        </div>

                        <div class="form-group">
                            <label>Ciudad</label>
                            <select name="city" id="city_input" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="owner" id="owner_input">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                <label>Latitud</label>
                                <input type="number" step="any" name="lat" id="lat_input" placeholder="Clic en el mapa..." readonly>
                            </div>
                            <div class="form-group">
                                <label>Longitud</label>
                                <input type="number" step="any" name="lng" id="lng_input" placeholder="Clic en el mapa..." readonly>
                            </div>
                        </div>
        ...
        <div id="cuentas_dia" class="section hidden">
            ...
            <form id="accountsForm" class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="total_consignar" id="total_consignar" readonly style="background: #e9ecef;">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="total_entrega_quala" id="total_entrega_quala" readonly style="background: #e9ecef;">
                </div>
                ...
                <div class="form-group full-width">
                    ...
                    <input type="text" name="total_descuadre" id="total_descuadre" readonly style="font-size: 1.2rem;">
                </div>
    ...
    <script>
        ...
        // Show default section (Today's Route) will be handled in JS init
        // But for fallback or initial HTML state
        // showSection('ruta_hoy', document.querySelector('.sidebar-menu a'));
    </script>
</body>
</html>
